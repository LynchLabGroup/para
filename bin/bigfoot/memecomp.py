...
class MotifFile(object):
	"""
	Parsed motif file generated by custom script. Convert all motifs into WeightedMotif objects, extensions of the Motif object in Bio.motifs.meme (Biopython). That way, motifs can be compared easily.
	"""
