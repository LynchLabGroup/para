...
def main():
	...
	### Command-line Parser ###
	parser = argparse.ArgumentParser(description="Setup program to parse BigFoot's outputs and find motifs.\n From sequence alignment and prediction files, it produces a file showing found motifs according to specific parameters. To have more information on BigFoot http://sourceforge.net/projects/bigfoot/")
