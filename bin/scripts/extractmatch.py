...
def main():
    ...
    parser = argparse.ArgumentParser(description="Simple script to rewrite a\
        fasta file using the names of another fasta file.")

    parser.add_argument("name", help="Fasta file from which you want to\
        extract names")
